...
export const generatePrompt = (params: DishParamsType) => {
  ...
  Example:[{"title": 'Recipe Title', "ingredients": [ [Ingredient, Measurement], [Ingredient, Measurement], ...rest ], "instruction": [ Please provide the cooking instruction as an array of steps and must not assign sequence numbers ] },{"title": 'Recipe Title', "ingredients": [ [Ingredient, Measurement], [Ingredient, Measurement], ...rest ], "instruction": [ Please provide the cooking steps as an array of steps and do not assign sequence numbers ] }, ...rest of the recipes]
